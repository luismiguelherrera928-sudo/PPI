    ...
    <footer className="footer-principal pt-5 pb-0">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="d-flex align-items-center gap-2 mb-3">
              ...
              <span className="logo-texto">
                <span className="logo-principal">CRIPTON</span>
                <span className="logo-secundario text-warning">GUARD </span>
              </span>
            </div>
            <p className="text-light opacity-75 mb-3">
              Empresa certificada en la informacion de los vendedores y los
               compradores, para mas sefuridad, con sanciones o eliminación de la cuenta 
            </p>
      ...
      <div className="footer-bottom text-center py-3 mt-2">
        <small className="text-light opacity-50">
          © {anioActual} criptonguard  — Todos los derechos reservados.
          &nbsp;·&nbsp; NIT 900.123.456-7
        </small>
      </div>
    </footer>
